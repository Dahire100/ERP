...
export default function ParentHomework() {
  const assignments = [
    { id: 1, subject: "Mathematics", title: "Algebra Problems", dueDate: "2025-01-18", status: "Pending", priority: "High", description: "Complete exercises 1-10 from chapter 5" },
    { id: 2, subject: "Science", title: "Lab Report", dueDate: "2025-01-20", status: "Pending", priority: "Medium", description: "Write report on chemistry experiment" },
    { id: 3, subject: "English", title: "Essay Writing", dueDate: "2025-01-15", status: "Submitted", priority: "Low", description: "Essay on environmental conservation", score: 92 },
    { id: 4, subject: "History", title: "Chapter Summary", dueDate: "2025-01-12", status: "Graded", priority: "Low", description: "Summarize chapter 3", score: 88 },
    { id: 5, subject: "Mathematics", title: "Geometry Assignment", dueDate: "2025-01-10", status: "Graded", priority: "Medium", description: "Solve geometry problems", score: 95 },
  ]
