...
const rows = [
  { id: 1, item: "Notebooks (A4)", category: "Stationery", unit: "Pieces", minStock: 100 },
  { id: 2, item: "Projector Bulbs", category: "Electronics", unit: "Pieces", minStock: 5 },
]
          ...
          <CardContent className="pt-6 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="space-y-2">
                ...
                <Input placeholder="Item" className="bg-white border-gray-200" />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input placeholder="Pieces / Units" className="bg-white border-gray-200" />
              </div>
              <div className="space-y-2">
                <Label className="text-red-500">Min Stock *</Label>
                <Input placeholder="e.g. 10" className="bg-white border-gray-200" />
              </div>
            </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-pink-50 hover:bg-pink-50">
                    ...
                    <TableHead className="font-bold text-gray-700 uppercase">Unit</TableHead>
                    <TableHead className="font-bold text-gray-700 uppercase text-right">Min Stock</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {rows.map((row) => (
