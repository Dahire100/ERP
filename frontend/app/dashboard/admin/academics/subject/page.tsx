...
const initialRows = [
  { id: 1, name: "KSV Math", type: "Theory", code: "KSV-MTH" },
  { id: 2, name: "KSV Hindi", type: "Theory", code: "KSV-HIN" },
  { id: 3, name: "KSV BBP", type: "Theory", code: "KSV-BBP" },
]
                ...
                <div className="flex items-center gap-6">
                  <label className="flex items-center gap-2 text-sm text-gray-700">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        setForm({ ...form, theory: Boolean(checked) })
                      }
                    />
                    Theory
                  </label>
                  <label className="flex items-center gap-2 text-sm text-gray-700">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        setForm({ ...form, practical: Boolean(checked) })
                      }
                    />
                    Practical
                  </label>
